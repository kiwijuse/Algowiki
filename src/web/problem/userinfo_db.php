...
echo '<div style="position: absolute; bottom: -50px; left: 0; right: 0; margin-left: auto; margin-right: auto; width:350px; border-radius:20px; border: 1px solid #E2E3E4;height:40px;display: flex; flex-direction: column;">
...
echo '<div id="singleRight" class="arrow"><center>&rsaquo;</center></div>
    	<div id="doubleRight" class="arrow"><center>&raquo;</center></div></div></div></div>';
...
echo '<div style="position: absolute; bottom: -30px; left: 0; right: 0; margin-left: auto; margin-right: auto; width:350px; border-radius:20px; border: 1px solid #E2E3E4;height:40px;display: flex; flex-direction: column;">
    <div class="pagination-container">
    <div id="doubleLeft" class="arrow"><center>&laquo;</center></div>
    <div id="singleLeft" class="arrow"><center>&lsaquo;</center></div>';
