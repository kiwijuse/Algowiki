...
<?php if (isset($_SESSION[$OJ_NAME.'_'.'administrator'])){?>
  <br><a class='btn btn-block btn-sm' href="http://<SERVER_IP>" target="_top"><b>메인페이지 이동</b></a>
<?php }?>
<br>
<center>
...
<?php if (isset($_SESSION[$OJ_NAME.'_'.'administrator'])){?>
  <br><a class='btn btn-block btn-sm' href="https://github.com/zhblue/hustoj/" target="_blank"><b>HUSTOJ github</b></a>
  <br><a class='btn btn-block btn-sm' href="https://github.com/zhblue/freeproblemset/" target="_blank"><b>FreeProblemSet</b></a>
  <br><a class='btn btn-block btn-sm' href="http://tk.hustoj.com" target="_blank"><b>문제은행 중국 웹사이트</b></a>
