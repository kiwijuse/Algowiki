...
React를 얹는 선택지도 있었지만 서버가 이미 PHP로 HTML을 만드는데
...
브라우저가 상태를 들고 있으니 JS가 할 일은 URL 이동뿐입니다.
...
게임화 사이트에서 가장 공들여야 할 곳은 **보상을 받는 순간**입니다.
...
폭죽은 화면 **좌우 두 지점**에서 동시에 터집니다. 남은 시간에 비례해 입자 수를 줄여
자연스럽게 잦아들게 했습니다.
