...
초심자는 이 루프가 지루해 이탈하고 다음에 뭘 풀어야 할지도 모릅니다.
...
문제를 풀어 퀘스트를 깨고 받은 재화로 상점에서 프로필 테두리를 사서 착용하기까지 —
전체 흐름을 6분 25초에 담았습니다.

https://github.com/user-attachments/assets/50a6829e-dd9e-4c87-bced-a87566e1358f

> 원본 화질(1080p · 60fps)은 [Releases](../../releases/tag/v1.0) 에서 받을 수 있습니다.
...
> [!TIP]
> 닉네임 색을 **사이트 전역**(채점 현황 · 랭킹 · 게시판)에 반영한 결정이 중요했습니다.
...
직접 얹었고 나머지 채점 파이프라인은 HUSTOJ를 그대로 썼습니다.
