...
<body>
    ...
    <div class="container mx-auto px-4 py-8 rounded-lg"
        style="background:white; width:98%;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;border: 1px solid #E2E3E4;">
...
function changeaddress(){
	var newURL = "problem_list.php?sorting=" + $('#Sorting').val() + "&filter1=" + $('#Filter1').val() + "&filter2=" + $('#Filter2').val() + "&filter3=" + $('#Filter3').val() + "&page=" + $('#Page').val() + "&pageset=" + $('#pageset').val() + "&show_tag=" + $('#show_tag').val() + "&show_problem=" + $('#show_problem').val() + "&search=" + $('#search').val();
