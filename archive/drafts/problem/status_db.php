...
foreach ($result as $row){
	...
	if($row["result"] == 0){
	echo '<td style="vertical-align:middle;"><center><a href="reinfo.php?sid='.$row["solution_id"].'" class="label label-warning" title="">채점 대기 중</a></center></td>';
	}else if($row["result"] == 1){
	echo '<td style="vertical-align:middle;"><center><a href="reinfo.php?sid='.$row["solution_id"].'" class="label label-warning" title="">채점 준비 중</a></center></td>';
	}else if($row["result"] == 2){
	echo '<td style="vertical-align:middle;"><center><a href="reinfo.php?sid='.$row["solution_id"].'" class="label label-warning" title="">컴파일 중</a></center></td>';
	}else if($row["result"] == 3){
	echo '<td style="vertical-align:middle;"><center><a href="reinfo.php?sid='.$row["solution_id"].'" class="label label-warning" title="">채점 중</a></center></td>';
	...
	echo '<td style="vertical-align:middle;"><center><a href="reinfo.php?sid='.$row["solution_id"].'" class="label label-success" title="">수동확인 대기중...</a></center></td>';
	}
