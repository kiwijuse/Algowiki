...
<div class="main" >
   ...
   <?php } ?>
	...
	<div>
		...
		<div class="setting_small" onclick="ajax(3);toggleSelection(3)">GitHub User Name 변경</div>
		<div class="setting_small" onclick="ajax(4);toggleSelection(4)">한줄 소개 변경</div>
	...
	<div style="margin-left:40px;width:100%;position:relative;" id="ajax"></div>	
...
function save(){
    if (saveInProgress) {
        // 이미 실행 중이라면 중복 실행을 방지하기 위해 함수를 빠져나갑니다.
        return;
    }
    saveInProgress = true;
