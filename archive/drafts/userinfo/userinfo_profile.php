...
<?php 
	$sql = "select user_git_id,streak_color,nick_color from users where user_id = '$user'";
	$user_info = pdo_query($sql);
	$user_git_id = $user_info[0][0];
	$streak_color = $user_info[0][1];
	$nick_color = $user_info[0][2];
...
<div class="ui grid">
    <div class="row">
		...
		<div style="height:33%;width:100%;">
			...
			<div class="flex-container"style="margin-left:30px; margin-right:30px; display:flex;text-align: center;height:90%;">
				<div style="width:25%;overflow:hidden;margin:0 auto;">
				<img src="https://www.uhs.ac.kr/sites/uhs/images/sub/logo-col.png" style="height:90%;width:auto;">
				</div>
				<div style="width:25%">
				<img src="/image/mainicon_santa.png" style="height:90%;width:auto;">
				</div>
				<div style="width:25%">
